    ...
    <div className="panel imaging-panel">
      <div className="imaging-head">
        ...
        <div className="imaging-controls">
          ...
          <button className="btn btn-secondary" type="button" onClick={() => setZoom((z) => Math.max(1, z - 0.1))}>
            <ZoomOut size={14} />
          </button>

          <button className="btn btn-secondary" type="button" onClick={() => setZoom((z) => Math.min(2, z + 0.1))}>
            <ZoomIn size={14} />
          </button>
        </div>
      </div>
      ...
      <div className="imaging-grid">
        <div className="imaging-cell">
          <img src={imageUrl} alt="Source eye" style={{ transform: `scale(${zoom})` }} />
          <span className="imaging-tag">SOURCE</span>
        </div>

        <div className="imaging-cell">
          <img src={imageUrl} alt="Attention base" style={{ transform: `scale(${zoom})` }} />
          {showOverlay && (
            <div
